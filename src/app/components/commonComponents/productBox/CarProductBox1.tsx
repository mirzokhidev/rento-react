  ...
  return (
    <div className="featured-box">
      <div className="featured-main-img">
        <Link to={routes.Product.ProductDetail} className="featured-img">
      ...
      <div className="featured-content">
        <Link to={routes.Product.ProductDetail}>{data.title}</Link>
        ...
        <div className="featured-price">
          <h5>${data.price}</h5>
          <Link to={routes.Product.ProductDetail} className="arrow-btn">
